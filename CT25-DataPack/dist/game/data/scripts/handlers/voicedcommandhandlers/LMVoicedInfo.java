...
public class LMVoicedInfo implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(final String command, final L2PcInstance activeChar, final String target)
	{
		if (command.equalsIgnoreCase("lminfo"))
		{
			...
			{
				final String htmContent = USE_STATIC_HTML && !HTML.isEmpty() ? HTML : HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), "data/html/mods/LMEvent/Status.htm");
				...
				try
				{
					...
					/*
					 * htmltext += "<table width=\"260\">"; htmltext += "<tr><td width=\"50\">Pos</td><td width=\"130\">Name</td><td width=\"80\" align=\"center\">Points</td></tr>"; if (firstPositions != null) for (int i = 0; i < firstPositions.length; i++) { String[] row =
					 * firstPositions[i].split("\\,"); htmltext += "<tr><td>" + (i + 1) + "</td><td>" + row[0] + "</td><td align=\"center\">" + row[1] + "</td></tr>"; } htmltext += "</table>";
					 */
