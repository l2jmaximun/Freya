...
import ct25.xtreme.gameserver.instancemanager.HandysBlockCheckerManager.ArenaParticipantsHolder;
import ct25.xtreme.gameserver.model.L2Object;
import ct25.xtreme.gameserver.model.L2Skill;
import ct25.xtreme.gameserver.model.actor.L2Character;
import ct25.xtreme.gameserver.model.actor.instance.L2BlockInstance;
...
public class Dummy implements ISkillHandler
{
	...
	private final void useBlockCheckerSkill(final L2PcInstance activeChar, final L2Skill skill, final L2Object target)
	{
		if (!(target instanceof L2BlockInstance))
			return;

		final L2BlockInstance block = (L2BlockInstance) target;
