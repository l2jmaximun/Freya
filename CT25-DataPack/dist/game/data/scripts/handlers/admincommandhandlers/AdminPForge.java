...
import ct25.xtreme.gameserver.network.clientpackets.L2GameClientPacket;
import ct25.xtreme.gameserver.network.serverpackets.AdminForgePacket;
	...
	public boolean useAdminCommand(final String command, final L2PcInstance activeChar)
	{
		...
		if (command.equals("admin_forge"))
			...
			try
			{
				...
				{
					buf.flip();
					final L2GameClientPacket p = (L2GameClientPacket) GameServer.gameServer.getL2GamePacketHandler().handlePacket(buf, activeChar.getClient());
					if (p != null)
					{
