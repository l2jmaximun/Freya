package instances.ChamberOfDelusion.South;
...
public class South extends Quest
{
	...
	public String onTalk(final L2Npc npc, final L2PcInstance player)
	{
		...
		if (npcId == ENTRANCE_GATEKEEPER)
			enterInstance(player, "South.xml");
		
		return "";
	}

	public South(final int questId, final String name, final String descr)
	{
