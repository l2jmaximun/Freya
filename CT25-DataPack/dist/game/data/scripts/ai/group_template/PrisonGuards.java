...
public class PrisonGuards extends L2AttackableAIScript
{
	...
	public PrisonGuards(final int questId, final String name, final String descr)
	{
	...
	public String onAdvEvent(final String event, final L2Npc npc, final L2PcInstance player)
	{
		...
		{
			final L2Npc newGuard = addSpawn(npc.getId(), npc.getSpawn().getLocx(), npc.getSpawn().getLocy(), npc.getSpawn().getLocz(), npc.getSpawn().getHeading(), false, 0);
	...
	private void castDebuff(final L2Npc npc, final L2Character player, final int effectId, final boolean isSummon, final boolean fromAttack, final boolean isSpell)
	{
		if (fromAttack)
		{
			/*
			 ...
			 */
			final int msg = npc.getId() == GUARD1 ? 1800107 : 1800108;
