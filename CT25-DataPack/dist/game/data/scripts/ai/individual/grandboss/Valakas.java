...
public class Valakas extends L2AttackableAIScript
{
	...
	public Valakas(final int id, final String name, final String descr)
	{
		...
		if (status == DEAD)
		{
			...
			else
			{
				...
				final L2GrandBossInstance valakas = (L2GrandBossInstance) addSpawn(VALAKAS, -105200, -253104, -15264, 0, false, 0);
	...
	public String onAdvEvent(final String event, final L2Npc npc, final L2PcInstance player)
	{
		...
		{
			final L2GrandBossInstance valakas = (L2GrandBossInstance) addSpawn(VALAKAS, -105200, -253104, -15264, 32768, false, 0);
			GrandBossManager.getInstance().addBoss(valakas);
			GrandBossManager.getInstance().setBossStatus(VALAKAS, DORMANT);
		}
	...
	public String onKill(final L2Npc npc, final L2PcInstance killer, final boolean isPet)
	{
		...
		final long respawnTime = (long) Config.Interval_Of_Valakas_Spawn + getRandom(Config.Random_Of_Valakas_Spawn);
	...
	public void getRandomSkill(final L2Npc npc)
	{
		...
		if (i2 > 0)
		{
			...
			if (npc.getCurrentHp() > npc.getMaxHp() * 1 / 4)
			{
				...
				if (c2.getZ() < npc.getZ() + 200)
				{
					...
					else if (getRandom(2) == 0) // TODO: replace me with direction, to check if player standing on left or right side of valakas
	...
	public void callSkillAI(final L2Npc npc, L2Character c2, final L2Skill skill)
	{
		final QuestTimer timer = getQuestTimer("1003", npc, null);
	...
	public void broadcastSpawn(final L2Npc npc)
	{
