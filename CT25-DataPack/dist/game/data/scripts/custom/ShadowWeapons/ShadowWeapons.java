...
public class ShadowWeapons extends Quest
{
	...
	public ShadowWeapons(final int questId, final String name, final String descr)
	{
	...
	public String onTalk(final L2Npc npc, final L2PcInstance player)
	{
		...
		final boolean playerOwnsDGradeExchangeCoupons = st.getQuestItemsCount(D_GRADE_COUPON) > 0;
		final boolean playerOwnsCGradeExchangeCoupons = st.getQuestItemsCount(C_GRADE_COUPON) > 0;
