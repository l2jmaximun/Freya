...
public final class SubClassSkills extends Quest
{
	...
	public SubClassSkills(final int id, final String name, final String descr)
	{
		super(id, name, descr);
	...
	public String onEnterWorld(final L2PcInstance player)
	{
		...
		{
			if (hasCertSkills)
				for (final L2Skill s : certSkills)
				{
	...
	private L2Skill[] getCertSkills(final L2PcInstance player)
	{
	...
	private L2ItemInstance[] getCertItems(final L2PcInstance player)
	{
