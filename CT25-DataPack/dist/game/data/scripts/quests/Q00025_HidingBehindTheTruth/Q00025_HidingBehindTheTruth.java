...
public class Q00025_HidingBehindTheTruth extends Quest
{
	...
	public String onAdvEvent(final String event, final L2Npc npc, final L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "SAY_TRIYOL":
			{
				npc.broadcastPacket(new NpcSay(npc.getObjectId(), Say2.ALL, npc.getId(), "That box was sealed by my master, $s1! Don't touch it!").addStringParameter(player.getName()));
				break;
			}
			case "DESPAWN_TRIYOL":
			{
