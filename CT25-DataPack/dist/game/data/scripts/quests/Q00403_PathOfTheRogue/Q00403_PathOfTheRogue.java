...
import ct25.xtreme.gameserver.model.holders.ItemChanceHolder;
...
public final class Q00403_PathOfTheRogue extends Quest
{
				...
				case 0:
				{
					...
					else
					{
						if (npc.getId() == CATS_EYE_BANDIT)
							attacker.sendPacket(new NpcSay(npc, Say2.NPC_ALL, "You childish fool, do you think you can catch me?"));
	...
	public String onKill(final L2Npc npc, final L2PcInstance killer, final boolean isSummon)
	{
		...
		if (qs != null && qs.isStarted() && npc.isScriptValue(1) && Util.checkIfInRange(1500, npc, killer, true))
			if (npc.getId() == CATS_EYE_BANDIT)
			{
				npc.broadcastPacket(new NpcSay(npc, Say2.NPC_ALL, "I must do something about this shameful incident..."));
	...
	private boolean checkWeapon(final L2PcInstance player)
	{
